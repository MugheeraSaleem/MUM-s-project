                  ...
                  child: Container(
                    ...
                    child: Container(
                      child: const ListTile(
                        ...
                        subtitle: Text(
                            'Very well explained. I love reading it after practice.',
                            style: TextStyle()),
                      ),
                    ),
                  ),
                      ...
                      children: <Widget>[
                        Container(
                          child: const ListTile(
                            ...
                            title:
                                Text('Richa Sharma ★★★★★', style: TextStyle()),
                            subtitle: Text(
                                'Learning all this in pregnancy helps me a lot. Highly recommended to read.',
                                style: TextStyle()),
                          ),
                        ),
                        Padding(
                      ...
                      children: <Widget>[
                        Container(
                          child: const ListTile(
                            ...
                            title:
                                Text('Sonia Gandhi ★☆☆☆☆', style: TextStyle()),
                            subtitle: Text("I don't like the scheme..",
                                style: TextStyle()),
                          ),
                        ),
                        Padding(
