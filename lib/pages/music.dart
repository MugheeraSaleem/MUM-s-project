    ...
    return SleekCircularSlider(
      ...
      appearance: CircularSliderAppearance(
        ...
        customColors: CustomSliderColors(
          progressBarColor: const Color(0xFFFE1483),
          trackColor: Colors.red.withOpacity(.5),
        ),
      ),
      onChange: (double percent) {
        setState(() {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
        ...
        appBar: AppBar(
          ...
          actions: <Widget>[
            IconButton(
              icon: const Icon(Icons.menu, color: Color(0xFFFE1483)),
              onPressed: () {},
            )
          ],
        ),
                    ...
                    children: <Widget>[
                      Container(
                        decoration: BoxDecoration(
                            color: const Color(0xFFFE1483).withOpacity(.5),
                  ...
                  children: <Widget>[
                    Center(
                      child: Container(
                        ...
                        decoration: BoxDecoration(
                            border: Border.all(
                                color: const Color(0xFFFE1483), width: 3.0),
    ...
    child: Row(
      ...
      children: <Widget>[
        ...
        Column(
          ...
          children: <Widget>[
            Text(title, style: const TextStyle(color: Color(0xFFFE1483))),
            Text(subtitle, style: const TextStyle(color: Color(0xFFFE1483)))
          ],
        )
      ],
    ),
